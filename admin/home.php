...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a id="btnAdd" href="add.php">Ajouter Nouvel Offre</a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                </ul>
            </div>
            ...
            <div class="container"> 
                <div class="contentOffre">
                    <div class="containerExpirer">
                        ...
                        <!-- ******************* Les offres restantes ontre 15 jours ou moins pour expirer ******************* -->
                        <div class="contentExpirer">
                            <?php
                                $conn = $pdo->open();
                                try{
                                    ...
                                    if($row['numrows'] > 0){
                                        echo "
                                            <a class='linktextExpirer' href='searcheOffre.php?choix=2'>
                                                <center>
                                                    <div>
                                                        <span class='textExpirer textExpirerRond'> " .$row['numrows'] ."</span>
                                                    </div>
